...
class ObjectLoader extends Component {
    ...
    sceneSetup = () => {
        ...
        this.renderer = new THREE.WebGLRenderer({
            antialias: true,
            // use preserve drawing buffer for snapshot
    ...
    handleUpdate = () => {
        ...
        this.mesh.rotation.x = THREE.Math.degToRad(
            this.props.object.config.rotate[0]
        );
        this.mesh.rotation.y = THREE.Math.degToRad(
            this.props.object.config.rotate[1]
        );
        this.mesh.rotation.z = THREE.Math.degToRad(
            this.props.object.config.rotate[2]
        );
        ...
        this.scene.background = new THREE.Color(
            this.props.object.config.background_color
        );
    ...
    render() {
        ...
        if (this.state.complete) {
            ...
            loaded =
                (this.state.loaded / this.state.size).toFixed(2) * 100 + '%';
        }
