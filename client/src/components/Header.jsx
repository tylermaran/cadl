			...
			<div className="home_content_box">
				<div className="home_message">
					...
					<p className="home_message_body">
						...
						customize, and improve on anything here.
					</p>
				</div>

				<div className="home_message">
					<h3 className="home_message_title">SHARE-YOUR-CREATION</h3>
					<p className="home_message_body">
						Want to contribute your own designs?{' '}
						<Link to="/create">Create a project here!</Link>
					</p>
				</div>
				<div className="home_message">
					<h3 className="home_message_title">LEARN-TO-DESIGN</h3>
					<p className="home_message_body">
